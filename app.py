...
if uploaded_file:
     ...
     #connects the program to openAI 
    #                                 #dont do this for real world life application as the key is getting exposed
     ...
     #       input=text)     #embedding is the feature under openAI, create is the request sent to openAi server, input=text is the actual data from the pdf sent to the oPENAI server
     ...
     index = faiss.IndexFlatL2(384)   #Index is the storage for embeddings
